...
public class testClackData{
    public static void main(String[] args) throws IOException {
        ClackData dm1 = new MessageClackData("testUser", "test message", 1);
        ClackData dmEQ = new MessageClackData("testUser", "test message", 1);
        ClackData dm2 = new MessageClackData("testUser", "test message", "key", 1);
        ClackData dm3 = new MessageClackData();

        FileClackData df1 = new FileClackData("testUser", "example.txt", 1);
        FileClackData dfEQ = new FileClackData("testUser", "example.txt", 1);
